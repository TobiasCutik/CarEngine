...
void ChLinkPointFrameGeneric::InjectConstraints(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
...
void ChLinkPointFrame::InjectConstraints(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
