...
void ChLinkPointTriface::InjectConstraints(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
...
void ChLinkPointTrifaceRot::InjectConstraints(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
