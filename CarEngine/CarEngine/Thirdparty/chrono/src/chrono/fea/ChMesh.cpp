...
void ChMesh::InjectKRMmatrices(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
...
void ChMesh::InjectVariables(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
