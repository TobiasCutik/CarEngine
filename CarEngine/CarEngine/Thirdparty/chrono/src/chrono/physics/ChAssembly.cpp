...
void ChAssembly::InjectVariables(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
...
void ChAssembly::InjectConstraints(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
...
void ChAssembly::InjectKRMmatrices(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
