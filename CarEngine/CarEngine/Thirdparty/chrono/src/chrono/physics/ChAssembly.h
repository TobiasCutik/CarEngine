...
class ChApi ChAssembly : public ChPhysicsItem {
  public:
    ...
    virtual void InjectVariables(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) override;

    virtual void InjectConstraints(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) override;
    virtual void ConstraintsLoadJacobians() override;

    virtual void InjectKRMmatrices(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) override;
