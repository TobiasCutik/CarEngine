...
template <class Tcont>
void _InjectConstraints(std::list<Tcont*>& contactlist, const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
...
void ChContactContainerNSC::InjectConstraints(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
