...
template <class Tcont>
void _InjectKRMmatrices(std::list<Tcont*> contactlist, const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
    typename std::list<Tcont*>::iterator itercontact = contactlist.begin();
    while (itercontact != contactlist.end()) {
...
void ChContactContainerSMC::InjectKRMmatrices(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
