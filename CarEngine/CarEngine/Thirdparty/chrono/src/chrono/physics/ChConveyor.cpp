...
void ChConveyor::InjectVariables(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
...
void ChConveyor::InjectConstraints(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
