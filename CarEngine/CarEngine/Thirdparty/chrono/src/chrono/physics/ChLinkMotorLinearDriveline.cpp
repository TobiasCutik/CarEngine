...
void ChLinkMotorLinearDriveline::InjectConstraints(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
...
void ChLinkMotorLinearDriveline::InjectVariables(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
