...
void ChLinkMotorRotationDriveline::InjectConstraints(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
...
void ChLinkMotorRotationDriveline::InjectVariables(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
