...
void ChLinkTSDA::InjectVariables(const std::shared_ptr<ChSystemDescriptor>& descriptor) {
...
void ChLinkTSDA::InjectKRMmatrices(const std::shared_ptr<ChSystemDescriptor>& descriptor) {
