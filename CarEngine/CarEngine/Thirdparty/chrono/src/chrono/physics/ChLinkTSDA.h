...
class ChApi ChLinkTSDA : public ChLink {
  ...
  private:
    ...
    virtual void InjectVariables(const std::shared_ptr<ChSystemDescriptor>& descriptor) override;
    virtual void InjectKRMmatrices(const std::shared_ptr<ChSystemDescriptor>& descriptor) override;
