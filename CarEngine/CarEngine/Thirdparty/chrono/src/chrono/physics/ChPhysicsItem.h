...
class ChApi ChPhysicsItem : public ChObj {
  public:
    ...
    virtual void InjectVariables(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {}
    ...
    /// Basically does nothing, but maybe that inherited classes may specialize this.
    virtual void InjectConstraints(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {}
    ...
    /// Basically does nothing, but maybe that inherited classes may specialize this.
    virtual void InjectKRMmatrices(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {}
