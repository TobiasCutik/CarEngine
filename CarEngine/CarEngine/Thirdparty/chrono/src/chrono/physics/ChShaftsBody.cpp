...
void ChShaftsBody::InjectConstraints(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
...
void ChShaftsBodyTranslation::InjectConstraints(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
