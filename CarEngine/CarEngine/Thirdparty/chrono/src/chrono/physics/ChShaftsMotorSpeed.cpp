...
void ChShaftsMotorSpeed::InjectConstraints(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
...
void ChShaftsMotorSpeed::InjectVariables(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
