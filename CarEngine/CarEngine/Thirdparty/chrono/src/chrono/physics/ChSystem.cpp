...
void ChSystem::DescriptorPrepareInject(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
...
void ChSystem::InjectVariables(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
...
void ChSystem::InjectConstraints(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
...
void ChSystem::InjectKRMmatrices(const std::shared_ptr<ChSystemDescriptor>& mdescriptor) {
