...
class ChApi ChSystem : public ChIntegrableIIorder {
  ...
  protected:
    ...
    virtual void DescriptorPrepareInject(const std::shared_ptr<ChSystemDescriptor>& mdescriptor);
  ...
  public:
    ...
    void InjectVariables(const std::shared_ptr<ChSystemDescriptor>& mdescriptor);

    void InjectConstraints(const std::shared_ptr<ChSystemDescriptor>& mdescriptor);
    void ConstraintsLoadJacobians();

    void InjectKRMmatrices(const std::shared_ptr<ChSystemDescriptor>& mdescriptor);
